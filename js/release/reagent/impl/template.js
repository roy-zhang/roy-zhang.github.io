...
var G__26233 = o;
(G__26233[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__26237 = o;
(G__26237[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__26242 = props;
var G__26242__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26242,cljs.core.cst$kw$id,id):G__26242);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26242__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26243){
...
var props = map__26244__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26244__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__26244,map__26244__$1,props,class$){
return (function (c){
...
});})(map__26244,map__26244__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26246){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26247__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__26247,map__26247__$1,on_write){
return (function (){
...
});})(node_value,map__26247,map__26247__$1,on_write))
);
} else {
...
var G__26250 = jsprops;
(G__26250["defaultValue"] = value);

(G__26250["onChange"] = ((function (G__26250,v,value,on_change){
return (function (p1__26249_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26249_SHARP_);
});})(G__26250,v,value,on_change))
);
...
var vec__26253 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26253,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26253,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26253,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___26257 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___26257 == null)){
} else {
var key_26258 = temp__5724__auto___26257;
(jsprops["key"] = key_26258);
}
...
var temp__5724__auto___26259 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___26259 == null)){
} else {
var key_26260 = temp__5724__auto___26259;
reagent.impl.template.oset(jsprops,"key",key_26260);
}
...
var G__26261 = reagent.impl.template.__GT_NativeWrapper();
(G__26261["name"] = c);
...
var G__26262 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26262) : reagent.impl.template.as_element.call(null,G__26262));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26266){
var G__26267 = cljs.core.first(seq26266);
var seq26266__$1 = cljs.core.next(seq26266);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26267,seq26266__$1);
});
...
break;
default:
var G__26273 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26273;
continue;
...
var n__4607__auto___26275 = a.length;
var i_26276 = (0);
while(true){
if((i_26276 < n__4607__auto___26275)){
(a[i_26276] = reagent.impl.template.as_element((a[i_26276])));

var G__26277 = (i_26276 + (1));
i_26276 = G__26277;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___26278 = a.length;
var i_26279 = (0);
while(true){
if((i_26279 < n__4607__auto___26278)){
var val_26280 = (a[i_26279]);
if(((cljs.core.vector_QMARK_(val_26280)) && ((reagent.impl.template.key_from_vec(val_26280) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26279] = reagent.impl.template.as_element(val_26280));

var G__26281 = (i_26279 + (1));
i_26279 = G__26281;
continue;
} else {
}
...
var ctx = ({});
var vec__26282 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26282,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26282,(1),null);
...
var G__26285 = (cljs.core.count(argv) - first_child);
switch (G__26285) {
case (0):
...
case (1):
var G__26286 = comp;
var G__26287 = jsprops;
var G__26288 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__26286,G__26287,G__26288) : reagent.impl.template.global$module$react.createElement.call(null,G__26286,G__26287,G__26288));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__26285){
